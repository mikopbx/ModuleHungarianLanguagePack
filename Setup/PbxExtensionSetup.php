...
namespace Modules\ModuleHungarianLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Hungarian Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Hungarian UI translations from Messages/hu/ directory
 * - Hungarian voice prompts from Sounds/hu-hu/ directory
 *
 ...
 *
 * @package Modules\ModuleHungarianLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleHungarianLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Hungarian packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Hungarian Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Hungarian Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Hungarian Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Hungarian Language Pack uninstalled successfully',
            LOG_INFO
        );
