...
namespace Modules\ModuleHungarianLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleHungarianLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * HungarianLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class HungarianLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-hungarian-language-pack';
